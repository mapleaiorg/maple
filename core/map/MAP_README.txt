...
Message Models (maple/core/map/models/message.py)
...
Protocol Server (maple/core/map/server/protocol_server.py)
...
Security Layer (maple/core/map/security/auth.py)
...
Middleware (maple/core/map/middleware/auth_middleware.py)
...
Main Entry Point (maple/core/map/__main__.py)
